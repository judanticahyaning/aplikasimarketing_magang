                                ...
                                <div class="modal-content bg-modal">
                                    ...
                                    <div class="modal-body bg-body-modal">
                                        <form action="<?= base_url('activity_am/addCust') ?>" method="post">
                                            ...
                                            <div class="form-group">
                                                <label>Segment</label>
                                                <select class="form-control" name="segmentCust" id="segmentCust">
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            ?>
                                                <td>
                                                    <center>
                                                        ...
                                                        <a class="btn btn-xs btn-danger customerDelete" href="<?= base_url('activity_am/deleteCust?id=' . $dataCust->id_customer); ?>"><i data-toggle="tooltip" title="Delete Data" class=" fas fa-trash"></i></a>
                                                        <center>
                                            ...
                                            ?>
                                                <td>
                                                    <center>
                                                        <a class="btn btn-xs btn-info text-white" data-toggle="modal" data-target="#editCustomer<?= $dataCust->id_customer; ?>">
                                                            <i data-toggle="tooltip" title="View Data" class="fas fa-eye"></i>
                                                        </a>
                                                        <center>
                        ...
                        <div class="modal fade" id="editCustomer<?= $idCust; ?>" tabindex="-1" role="dialog" aria-hidden="true">
                            <div class="modal-dialog" role="document">
                                <div class="modal-content bg-modal">
                                    ...
                                    <div class="modal-body bg-body-modal">
                                        <form action="<?= base_url('activity_am/editCustomer') ?>" method="post">
                                            <div class="form-group">
...
<script type="text/javascript">
    ...
    console.log(<?= $this->session->userdata('id_am'); ?>)
    let idcustomer = 0;
    let clickid;
