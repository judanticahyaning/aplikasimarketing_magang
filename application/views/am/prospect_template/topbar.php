			...
			<li class="nav-item dropdown hidden-caret">
				...
				<ul class="dropdown-menu dropdown-user animated fadeIn">
					<div class="dropdown-user-scroll scrollbar-outer">
						<li>
							<div class="user-box">
								<div class="avatar-lg"><img src="<?php echo base_url('assets/image/'); ?><?php echo $profile->foto_am; ?> " alt="image profile" class="avatar-img rounded"></div>
								<div class="u-text">
									<h4><?php
						...
						<li>
							...
							<a class="dropdown-item" href="<?= base_url('prospect_am/profile') ?>">My Profile</a>
