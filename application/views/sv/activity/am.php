                                    ...
                                    <div class="modal-body bg-body-modal">
                                        <form action="<?= base_url('/activity_sv/addAm') ?>" method="post">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input name="password" id="password" type="password" class="form-control" placeholder="Fill Password">
                                            </div>
                                    ...
                                    foreach ($am as $ams) { ?>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a class="btn btn-danger btn-xs AMdelete" role="button" href="<?= base_url('activity_sv/am?id=' . $ams->id_am); ?>"> <i data-toggle="tooltip" title="Delete Data" class=" fas fa-trash"></i></a></td>
                                        </tr>
                                    <?php } ?>
                        ...
                        <div class="modal fade" id="editAM" tabindex="-1" role="dialog" aria-hidden="true">
                            <div class="modal-dialog" role="document">
                                <div class="modal-content bg-modal">
                                    ...
                                    <div class="modal-body bg-body-modal">
                                        <form action="<?= base_url('/activity_sv/updateAM') ?>" method="post">
                                            <div class="form-group">
                                                <label>AM Code</label>
