		...
		<div class="sidebar-content">
					...
					<div class="collapse in" id="collapseExample">
						<ul class="nav ">
							<li class="nav-item">
								...
								<a class="nav-link" href="<?= base_url('activity_sv/profile') ?>">
			...
			<ul class="nav nav-primary">
				<?php if ($title == 'AM') { ?>
					...
					<?php } else { ?>
					<li class="nav-item">
					<?php } ?> <a class="nav-link" href="<?= base_url('activity_sv/am') ?>">
					...
					<?php if ($title == 'Plan') { ?>
						...
						<?php } else { ?>
						<li class="nav-item">
						<?php } ?> <a class="nav-link" href="<?= base_url('activity_sv/plan') ?>">
						...
						<?php if ($title == 'Activity') { ?>
							...
							<?php } else { ?>
							<li class="nav-item">
							<?php } ?> <a class="nav-link" href="<?= base_url('activity_sv/index') ?>">
								...
								<li class="nav-item active submenu">
									...
									<div class="collapse" id="sidebarLayouts" class="collapse show">
										<ul class="nav nav-collapse">
											<li class="active">
												<a class="nav-link" href="<?= base_url('activity_sv/dataCustomer') ?>">
													<span class="sub-item">Customer Data</span>
												</a>
											</li>
											<li>
												<a class="nav-link" href="<?= base_url('activity_sv/customer') ?>">
							...
							<?php if ($title == 'Log') { ?>
								...
								<a class="nav-link" href="<?= base_url('activity_sv/log') ?>">
								...
								<?php if ($title == 'About') { ?>
									...
									<?php } else { ?>
									<li class="nav-item">
									<?php } ?> <a class="nav-link" href="<?= base_url('activity_sv/about') ?>">
									...
									<?php if ($title == 'Privacy Policy') { ?>
										...
										<?php } else { ?>
										<li class="nav-item">
										<?php } ?> <a class="nav-link" href="<?= base_url('activity_sv/privacy') ?>">
										...
										<?php if ($title == 'Version') { ?>
											...
											<?php } else { ?>
											<li class="nav-item">
											<?php } ?> <a class="nav-link" href="<?= base_url('activity_sv/version') ?>">
